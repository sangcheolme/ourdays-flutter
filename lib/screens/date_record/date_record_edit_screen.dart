...
class _DateRecordEditScreenState extends State<DateRecordEditScreen> {
    ...
    _places = List.generate(
      2,
          ...
          Place(
            ...
            rating: 4 + (index % 2),
            review: index == 0
                ? '커피가 맛있었어요. 다음에 또 오고 싶어요.'
                : '영화가 재미있었어요. 팝콘도 맛있었어요.',
  ...
  Future<void> _updateDateRecord() async {
    ...
    try {
      final dateRecordProvider = Provider.of<DateRecordProvider>(
      ...
      final success = await dateRecordProvider.updateDateRecord(
          updatedDateRecord);
